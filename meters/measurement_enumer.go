...
const _MeasurementName = ""

var _MeasurementIndex = [...]uint16{0, 9, 16, 25, 34, 43, 50, 59, 68, 77, 82, 89, 96, 103, 114, 127, 140, 153, 164, 177, 190, 203, 216, 231, 246, 261, 274, 289, 304, 319, 325, 333, 341, 349, 352, 357, 362, 367, 370, 375, 380, 385, 390, 395, 401, 409, 417, 425, 433, 441, 447, 455, 463, 471, 479, 487, 498, 511, 524, 537, 550, 563, 577, 593, 609, 625, 641, 657, 671, 687, 703, 719, 735, 751, 760, 769, 776, 788, 799, 810, 819, 829, 840, 851, 860, 870, 881, 892, 901, 911, 922, 933, 942, 952, 963, 977, 987, 997, 1007, 1025, 1039, 1051, 1064, 1084, 1103, 1120, 1140, 1161, 1185, 1207}

const _MeasurementLowerName = ""
...
var _MeasurementNameToValueMap = map[string]Measurement{
	...
	_MeasurementName[987:997]:        BatterySOH,
	_MeasurementLowerName[987:997]:   BatterySOH,
	_MeasurementName[997:1007]:       BatterySOC,
	_MeasurementLowerName[997:1007]:  BatterySOC,
	_MeasurementName[1007:1025]:      BatteryTemperature,
	_MeasurementLowerName[1007:1025]: BatteryTemperature,
	_MeasurementName[1025:1039]:      BatteryCurrent,
	_MeasurementLowerName[1025:1039]: BatteryCurrent,
	_MeasurementName[1039:1051]:      BatteryPower,
	_MeasurementLowerName[1039:1051]: BatteryPower,
	_MeasurementName[1051:1064]:      BatteryStatus,
	_MeasurementLowerName[1051:1064]: BatteryStatus,
	_MeasurementName[1064:1084]:      BatteryCriticalFault,
	_MeasurementLowerName[1064:1084]: BatteryCriticalFault,
	_MeasurementName[1084:1103]:      BatteryWarningFault,
	_MeasurementLowerName[1084:1103]: BatteryWarningFault,
	_MeasurementName[1103:1120]:      BatteryAlertFault,
	_MeasurementLowerName[1103:1120]: BatteryAlertFault,
	_MeasurementName[1120:1140]:      BatteryRatedCapacity,
	_MeasurementLowerName[1120:1140]: BatteryRatedCapacity,
	_MeasurementName[1140:1161]:      BatteryMaxPowerCharge,
	_MeasurementLowerName[1140:1161]: BatteryMaxPowerCharge,
	_MeasurementName[1161:1185]:      BatteryMaxPowerDischarge,
	_MeasurementLowerName[1161:1185]: BatteryMaxPowerDischarge,
	_MeasurementName[1185:1207]:      BatteryAvailableEnergy,
	_MeasurementLowerName[1185:1207]: BatteryAvailableEnergy,
}
...
var _MeasurementNames = []string{
	...
	_MeasurementName[987:997],
	_MeasurementName[997:1007],
	_MeasurementName[1007:1025],
	_MeasurementName[1025:1039],
	_MeasurementName[1039:1051],
	_MeasurementName[1051:1064],
	_MeasurementName[1064:1084],
	_MeasurementName[1084:1103],
	_MeasurementName[1103:1120],
	_MeasurementName[1120:1140],
	_MeasurementName[1140:1161],
	_MeasurementName[1161:1185],
	_MeasurementName[1185:1207],
}
