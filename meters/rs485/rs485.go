...
func NewDevice(typeid string) (*Device, error) {
...
func (d *Device) Producer() Producer {
	return d.producer
}
...
func (d *Device) QueryOp(client modbus.Client, op Operation) (res meters.MeasurementResult, err error) {
	var bytes []byte
