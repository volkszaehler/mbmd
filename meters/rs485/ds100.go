...
func NewDS100Producer() Producer {
	...
	ops := Opcodes{
		...
		VoltageL2_L3:   	0x0408,
		VoltageL3_L1:   	0x040A,
		VoltageL_N_avg: 	0x040C,
		VoltageL_L_avg: 	0x040E,
		CurrentL1: 			0x0410,
		CurrentL2: 			0x0412,
		CurrentL3: 			0x0414,
		Current:   			0x0416,
		ThreePhase_Vec_A: 	0x0418,
		PowerL1:         	0x041A,
		PowerL2:         	0x041C,
		PowerL3:         	0x041E,
		Power:           	0x0420,
		...
		CosphiL2:  			0x0437,
		CosphiL3:  			0x0438,
		Cosphi:    			0x0439, //implemented from beginning till 0x0439 - 60 Registers so far - too many might lead tomdelayed readout
