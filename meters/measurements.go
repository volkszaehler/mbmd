...
var iec = map[Measurement]*measurement{
	...
	DCEnergyS1:       newInternalMeasurement(withDescription("String 1 Generation"), withUnit(units.KiloWattHour), withMetricType(Counter)),
	...
	DCEnergyS2:       newInternalMeasurement(withDescription("String 2 Generation"), withUnit(units.KiloWattHour), withMetricType(Counter)),
	...
	DCEnergyS3:       newInternalMeasurement(withDescription("String 3 Generation"), withUnit(units.KiloWattHour), withMetricType(Counter)),
